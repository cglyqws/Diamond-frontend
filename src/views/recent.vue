    ...
    <el-container>
      ...
      <el-main>
        ...
        <el-row  :gutter="10" style="width: 80%;">
          <el-col :span="8" v-for="file in filelist" style:>
            <el-button class="filebutton" icon="el-icon-document" style="border-radius: 0px; width: 100%; " @click="toedit(file)" >
              {{file.filename}}
            </el-button>
          </el-col>
        </el-row>
...
export default {
  ...
  data() {
    return {
      filelist:[
        {filename:'文档1',content:'这是文档1'},
        {filename:'文档2',content:'这是文档2'},
        {filename:'文档3',content:'这是文档3'},
        {filename:'文档4',content:'这是文档4'},],
      data: [{
        label: '我的团队',
        children: [{
          label: 'HLZZ',
  ...
  methods: {
    ...
    toedit:function (file)
    {
      console.log(file.filename)
      this.$router.push({ path: '/showdoc', query: file})
    }
